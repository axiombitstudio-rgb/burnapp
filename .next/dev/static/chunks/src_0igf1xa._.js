...
"[project]/src/components/BurnParchment.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function generateRaggedPath(w, h, seed = 42) {
    ...
    function edgeWobble(rng, t, baseJag, burstCenters, burstWidth, burstScale) {
    ...
    for(let i = 0; i <= segs; i++){
        const t = i / segs;
        const dy = edgeWobble(rngTop, t, 10, [
            0.62,
            0.85
        ], 0.14, 2.2);
        pts.push([
    ...
    for(let i = 0; i <= segs; i++){
        const t = i / segs;
        const dx = edgeWobble(rngRight, t, 9, [
            0.38,
            0.72
        ], 0.10, 1.8);
        pts.push([
    ...
    for(let i = 0; i <= segs; i++){
        const t = i / segs;
        const dy = edgeWobble(rngBottom, t, 11, [
            0.20,
            0.75
        ], 0.13, 2.4);
        pts.push([
    ...
    for(let i = 0; i <= segs; i++){
        const t = i / segs;
        const dx = edgeWobble(rngLeft, t, 8, [
            0.52
        ], 0.16, 2.0);
        pts.push([
            dx,
...
function BurnParchment({ text, trigger, onComplete }) {
    ...
    const coverCanvasRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    // fireCanvas: sits above everything, renders Doom fire
    const fireCanvasRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    // particleCanvas: ash
    const particleCanvasRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    const burnLineRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const fireGridRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    const burnDoneRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    ...
    const animate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "BurnParchment.useCallback[animate]": ()=>{
            ...
            const allDone = burnLine.every({
                "BurnParchment.useCallback[animate].allDone": (y)=>y <= 0
            }["BurnParchment.useCallback[animate].allDone"]);
            if (!allDone) {
                for(let x = 0; x < W; x++){
            ...
            particlesRef.current = particlesRef.current.filter({
                "BurnParchment.useCallback[animate]": (p)=>{
                    p.x += p.vx;
                    p.y += p.vy;
                    p.vy *= 0.96;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BurnParchment.useEffect": ()=>{
            ...
            rafRef.current = requestAnimationFrame(animate);
            return ({
                "BurnParchment.useEffect": ()=>cancelAnimationFrame(rafRef.current)
            })["BurnParchment.useEffect"];
        }
    }["BurnParchment.useEffect"], [
        trigger,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BurnParchment.useEffect": ()=>{
            ...
            return ({
                "BurnParchment.useEffect": ()=>clearTimeout(t)
            })["BurnParchment.useEffect"];
        }
    }["BurnParchment.useEffect"], [
        trigger,
...
_s(BurnParchment, "vpFL+lSkFrKHJUIYpbVW/J8ZtRU=");
_c = BurnParchment;
var _c;
__turbopack_context__.k.register(_c, "BurnParchment");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$BurnParchment$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/BurnParchment.tsx [app-client] (ecmascript)");
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$Screen$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$BurnParchment$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                    text: secret,
...
//# sourceMappingURL=src_0igf1xa._.js.map