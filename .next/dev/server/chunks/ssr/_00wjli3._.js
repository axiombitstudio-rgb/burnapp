...
const metadata = {
    ...
    description: "Type it. A stranger reads it for ten seconds. Then it's gone forever.",
    openGraph: {
        title: "Burn",
        description: "Say what you could never say. A stranger holds it for ten seconds. Then it's gone.",
        type: "website"
    }
};
